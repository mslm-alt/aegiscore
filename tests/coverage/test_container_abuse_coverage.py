...
from tests.coverage.container_abuse_helper import build_attack_scenarios, build_benign_scenarios
...
class TestContainerAbuseCoverage:
    ...
    def test_container_abuse_coverage_summary(self):
