...
from tests.coverage.downloader_stager_helper import build_attack_scenarios, build_benign_scenarios
...
class TestDownloaderStagerCoverage:
    ...
    def test_downloader_stager_coverage_summary(self):
