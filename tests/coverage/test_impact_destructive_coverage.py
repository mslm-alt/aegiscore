...
from tests.coverage.impact_destructive_helper import build_attack_scenarios, build_benign_scenarios
...
class TestImpactDestructiveCoverage:
    ...
    def test_impact_destructive_coverage_summary(self):
