...
from tests.coverage.lateral_movement_helper import build_attack_scenarios, build_benign_scenarios
...
class TestLateralMovementCoverage:
    ...
    def test_lateral_movement_coverage_summary(self):
