...
from tests.coverage.tool_install_abuse_helper import build_attack_scenarios, build_benign_scenarios
...
class TestToolInstallAbuseCoverage:
    ...
    def test_tool_install_abuse_coverage_summary(self):
