...
from tests.coverage.post_auth_abuse_helper import build_attack_scenarios, build_benign_scenarios
...
class TestPostAuthAbuseCoverage:
    ...
    def test_post_auth_abuse_coverage_summary(self):
