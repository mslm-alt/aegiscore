...
from tests.coverage.archive_exfil_helper import build_attack_scenarios, build_benign_scenarios
...
class TestArchiveExfilCoverage:
    ...
    def test_archive_exfil_coverage_summary(self):
